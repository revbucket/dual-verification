...
parser.add_argument('--eps', type=float, default=0.01960784313, required=False)
...
cifar_sgd = eu.load_cifar_sgd()

for idx in range(args.start_idx, args.end_idx):
    print('Handling CIFAR example %s' % idx)


    bin_net, test_input = eu.setup_cifar_example(cifar_sgd, idx, args.eps)
